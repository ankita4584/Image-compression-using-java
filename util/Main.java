...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            ImageIO.write(reconstructed, "png", new File("test_reconstructed_from_binary.png"));

            System.out.println("Binary file saved to: " + new File("compressed.qtc").getAbsolutePath());
